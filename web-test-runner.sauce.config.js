...
const sauceLabsCapabilities = {
	name: '@brightspace-hypermedia-components/d2l-questions unit tests',
	// eslint-disable-next-line no-undef
	build: `@brightspace-hypermedia-components/d2l-questions ${process.env.GITHUB_REF ?? 'local'} build ${process.env.GITHUB_RUN_NUMBER ?? ''}`
};
